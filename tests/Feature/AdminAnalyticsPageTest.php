...
class AdminAnalyticsPageTest extends TestCase
{
    ...
    public function test_analytics_page_renders_after_dashboard_nav_item(): void
    {
        ...
        $response
            ...
            ->assertSee(__('admin.analytics.filters.open_panel'))
            ->assertSee('data-analytics-filter-panel-toggle', false)
            ->assertSee('data-analytics-filter-panel aria-hidden="true"', false)
