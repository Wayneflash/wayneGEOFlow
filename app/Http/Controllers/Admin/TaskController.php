...
class TaskController extends Controller
{
    ...
    private function taskI18n(): array
    {
        ...
        return [
            ...
            'confirmStartTitle' => __('admin.tasks.confirm.start_title'),
            'confirmStopTitle' => __('admin.tasks.confirm.stop_title'),
            'confirmRunAllTitle' => __('admin.tasks.confirm.run_all_title'),
            'confirmDeleteTitle' => __('admin.tasks.confirm.delete_title'),
            'confirmDeleteButton' => __('admin.button.delete'),
            'confirmStopButton' => __('admin.button.pause'),
