...
return static function (array $welcomeState): array {
    ...
    return [
        'zh-CN' => [
            ...
            'letter' => [
                ...
                'blocks' => [
                    [
                        'type' => 'paragraph',
                        'content' => $titleZh !== '' ? $titleZh : '后台已经检测到深联云GEO有一个新版本可用。',
                    ],
                    [
                        'type' => 'paragraph',
        ...
        'en' => [
            ...
            'letter' => [
                'title' => 'A new 深联云GEO version is available',
                'subtitle' => 'Current version v'.$currentVersion.', latest version v'.$latestVersion.'.',
                'blocks' => [
                    [
                        'type' => 'paragraph',
                        'content' => $titleEn !== '' ? $titleEn : 'The admin has detected that a newer 深联云GEO release is available.',
                    ],
                    [
                        'type' => 'paragraph',
